          ...
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            ...
            <div class="container">
              ...
              <div class="row wow fadeIn">
                 <!--Grid column-->
                <div class="col-md-6 mb-4 text-white text-center text-md-left">
                  <br><br><br><br><br><br><br><br><br><br>
                  <h1 class="display-4 font-weight-bold">MECAs WoT Service</h1>
                  <hr class="hr-light">
                  <p>
                    <strong>Easily add other devices and install IoT gateway <br>on embedded Linux board.</strong><br>
