...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
      <!-- Navbar -->
        ...
        <!-- Full Page Intro -->
        <div class="view full-page-intro" style="background-image: url('18.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            ...
            <div class="container">
              ...
              <div class="row wow fadeIn">
                 <!--Grid column-->
                <div class="col-md-6 mb-4 text-black text-center text-md-left">
                  <br><br><br><br><br><br><br><br><br><br>
                  <font color="darkred"><h1 class="display-4 font-weight-bold">Contact us </h1></font>
                  <hr class="hr-light">
                  <p>
                    <strong>Internet Innovation Research Team (INO) <br>National Electronics and Computer Technology Center (NECTEC)<br></strong>
                    <strong>112 Thailand Science Park, Phaholyothin Road,<br>Klong Nueng, Klong Luang, Pathumthani 12120.<br>Email : ino@nectec.or.th<br>Tel : 02-564-6900</strong>
                  </p>
                  <hr class="hr-light">
                  <!-- <a target="_blank" href="{{ url('/getstarted') }}" class="btn btn-warning btn-lg ">Getting started
